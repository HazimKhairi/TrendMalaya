        ...
        <div className="flex items-center justify-between py-4">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs sm:text-sm font-medium text-[#5B0A0A] -mt-1">
                Mobile Shop MY
              </span>
            </div>
          </a>
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <a
                ...
                className="text-black hover:text-[#5B0A0A] px-3 py-2 text-base font-bold transition-colors"
              >
                {link.label}
              </a>
            ))}
            ...
            <div className="flex flex-col space-y-1">
              {navLinks.map((link) => (
                <a
                  ...
                  href={link.href}
                  onClick={(e) => handleScroll(e, link.href)}
                  className="text-black hover:text-[#5B0A0A] block px-4 py-3 min-h-[44px] rounded-md text-base font-bold hover:bg-gray-100 transition"
                >
                  {link.label}
                </a>
              ))}
